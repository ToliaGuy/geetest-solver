// K,133---2-.(!!Dt)y()()ys)(ssysty((tt(ys(!!($*534535453$)G3553$)9B(*442724$)l
// [12, 58, 98, 36, 43, 95, 62, 15, 12]
// 5549346d


var track = [[-19,-28,0],[0,0,0],[1,0,162],[5,0,173],[17,0,186],[30,0,196],[46,0,207],[61,0,219],[78,0,230],[93,0,241],[98,0,253],[110,0,263],[121,0,274],[130,0,286],[137,0,297],[141,0,309],[146,0,319],[152,1,331],[159,2,342],[167,2,353],[170,2,365],[176,3,376],[184,3,386],[191,4,399],[195,5,410],[198,5,420],[199,5,432],[199,5,791]]
...
var toString = function (track) {  // to string
    function e(e) {
      var t = [];
      var r = 0;
      var n;
  ...
  var userresponse = function (e, t) {  // usseresponse is everytime different
    var r = t["slice"](-2);
    var n = [];
...
var d = {
  ...
  // console.log(te["encrypt"](xe["stringify"](o), skuf()));
  ...
  var rdgJ = function (e) {
    var r = new Q()["encrypt"](skuf(e));

    while (!r || r["length"] !== 256) {
      r = new Q()["encrypt"](skuf(true));
    }
  ...
  (async () => {
  encoded_payload = {"gt":"81388ea1fc187e0c335c0a8907ff2625","challenge":"7730291a49f796b4d97c63318c6b9497e8","lang":"en","pt":0,"client_type":"web","w":"YAahqE2y7SLlch0(nDDgu2CNYLW4kgmI(WdTf628sqXvxdc)rVPACBr9JQv5vBZ9)zQXY3o06jAHZFHUefIxxPTfMXW0wLE))Sl77fyNOi6fp9skxQedxcw3vGWaxMCB2vpnH(qdWdCuOGN5CZwmIprEdKOw9o0MxB1cvTE0Kc4vdg)uSEGhANhiwUMMIWSo6r7gzAlVr0o31orDjq6M9VNb6zYxk0O)Piz35j7PuPF7eD5kzBXrXdA(veQBDbjdnW0CJS6gxz1zYRk0vRd1kXrb7BYj8OWFiFp36O2l(ariK6qddKr8NtNM6cpslmssFjw999TVZrBoI5n2VyXKZVspO(gXS1Pxx)MlJ(hDV4t8MXDD(bi8bXQXzrMIj)H5XcOCMvxWwGJlisI1PdQ177Dr8HZqF4v5rtOQbfSaUMQL31zHpiBIr8)Y(2GbbSRx5zHQNRg0ac3w4Xn44rqR7qCrNExoKv)xfabN)R4Dy6G2Rtcgup8IDm502FFJ22S3vGQkuWSB3E25BWYJ1fYlKdHoboV3)8iNHnL(Sx(AZZ5EgOvIfayFsWepnHIKEipepvBm8R7A9efc6qed35GIvb(WzWTZ8PGycJLr48OylBVlqg1WhGSAD5B5CVZclQJ3ukw6p19s4Dw7Uo)D)uq9XegBB9ArOtapF94p1NqwXwmpFjWUFWrcvVTKZXkd2V32ClFtRDBr2uwJowYlNyuKPDVYwDf2ulf8TbYlFBN7z2gjc7tTGi8F6f28(Yhv8)gLoIUB)FEhNu8O1WJLBYK1pn1q7o)6kCPYQD3TT1vx3QfSR1TWeCLRQu)aqDptBrp6dFd)nDey5WPWP9YFUeDicKGnysh3BA8Oo596jdPugutlbzDVccFuYKZLml435uinObVSlwW3e4CBSK8B7lNIOA..","callback":"geetest_1635375464650"}

  const resultResponse = await got(`https://api.geetest.com/ajax.php`,{searchParams: encoded_payload});
  console.log(resultResponse.body)
